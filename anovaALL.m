...
for s = 1:nparticipants
   ...
   mdl1 = fitglm(cj1,int1,'Distribution','binomial','Link','logit');
   scores1 = mdl1.Fitted.Probability;
   [X1,Y1,T1,AUC1] = perfcurve(wherelarger,scores1,1);
...
resolution = [alldata.resolution].';
resolution2 = [alldata.resolution2].';
correctInitial = [alldata.correctInitial].';
...
[d,p,stats] = manova1([algor2TrustDiff algor2Influence],algor2Choice,0.05);
...
X = [algor2Influence,algor2TrustDiff,resolution,swayDiff];
Y = algor2Choice;
